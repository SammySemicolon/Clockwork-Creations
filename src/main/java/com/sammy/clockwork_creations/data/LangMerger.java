...
public class LangMerger extends LanguageProvider {
    ...
    public LangMerger(DataGenerator gen) {
        super(gen, ClockworkCreationsMod.MODID, "en_us");
        this.gen = gen;
    }

    @Override
    protected void addTranslations() {
        Path path = gen.getOutputFolder().resolve("assets/" + ClockworkCreationsMod.MODID + "/lang/" + "en_us.json");
        ...
        addAll(fromResource("assets/" + ClockworkCreationsMod.MODID + "/lang/extra_lang.json").getAsJsonObject());
    }
